package ru.litvinov.patientnotificator.util;

public class Constants {

    public static final String SYSTEM_NAME = "Notificator";
    public static final String EXIT = "Выход";
    public static final String LAYOUTS = "Шаблоны";
    public static final String LAYOUT = "Шаблон";
